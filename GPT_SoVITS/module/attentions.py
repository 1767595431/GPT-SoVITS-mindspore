...
# --- Compatibility fix for MindSpore softmax signature ---
_softmax_lastdim = nn.Softmax(axis=-1)
def softmax_lastdim(x):
    """Unified softmax along last dimension, compatible with MindSpore versions"""
...
class MultiHeadAttention(nn.Cell):
    ...
    def attention(self, query, key, value, mask=None):
       ...
       # p_attn = ops.softmax(x=scores, axis=-1)  # [b, n_h, t_t, t_s]
        p_attn = softmax_lastdim(scores)  # [b, n_h, t_t, t_s]
